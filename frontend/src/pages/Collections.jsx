...
const Collections = () => {
      const {products,search,showSearch}=useContext(ShopContext);
       const [showFilters,setShowFilters]=useState(false);
        const [filterProucts,setfilterProducts]=useState([]);
           ...
           const [sortType,setSortType]=useState('relavent');
             ...
             const applyFilter=()=>{
              ...
              const sortProduct=()=>{
                       ...
                       let fpCopy=filterProucts.slice();
                        ...
                        switch(sortType){
                             ...
                             case 'hight-low':
                                   setShowFilters(fpCopy.sort((a,b)=>(b.price-a.price)));
                                   break;
